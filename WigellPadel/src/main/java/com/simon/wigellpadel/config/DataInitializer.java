    ...
    public CommandLineRunner initData() {
        ...
        return args -> {
            ...
            if(bookingRepository.count() == 0) {
                ...
                booking1.setTotalPriceEur(courtRepository.findById(1L).get().getPricePerHourEur());
                ...
                booking1.setTotalPriceEur(courtRepository.findById(2L).get().getPricePerHourEur());
